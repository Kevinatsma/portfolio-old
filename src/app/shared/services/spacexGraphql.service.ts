...
export type LaunchDetailsQuery = (
  ...
  & { launch: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'mission_name' | 'details' | 'launch_date_local' | 'launch_success'>
    & { launch_site: Maybe<(
      { __typename?: 'LaunchSite' }
      ...
      & { rocket: Maybe<(
        { __typename?: 'Rocket' }
        & Pick<Rocket, 'cost_per_launch' | 'description' | 'name' | 'wikipedia'>
        & { height: Maybe<(
          { __typename?: 'Distance' }
...
@Injectable({
  ...
  export const PastLaunchesListDocument =
    gql`
